...
int EndsWithJs(const char *str) { return EndsWith(str, ".js"); }
int EndsWithCss(const char *str) { return EndsWith(str, ".css"); }
int EndsWithPng(const char *str) { return EndsWith(str, ".png"); }
int EndsWithJpg(const char *str) { return EndsWith(str, ".jpg"); }
        ...
        *request_uri++ = '\0';
        ...
        if ((http_version = strchr(request_uri, ' ')) != NULL) {
                ...
                *http_version++ = '\0';
                ...
                if (EndsWithJs(request_uri) == 1) return 1;
                if (EndsWithJpg(request_uri) == 1) return 1;
                if (EndsWithPng(request_uri) == 1) return 1;
                if (EndsWithCss(request_uri) == 1) return 1;  
